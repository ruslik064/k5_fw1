...
#ifdef ENABLE_HORIZONTAL_MENU_UI

static inline void _DrawLayout(uint8_t Y, char String[])
{
    UI_PrintString(MenuList[gMenuCursor], 0, 127, Y, 8, true);

    memset(gFrameBuffer[Y + 2], 0x04, sizeof(gFrameBuffer[0]));

    NUMBER_ToDigits(gMenuCursor + 1, String);
    UI_DisplaySmallDigits(2, String + 6, 4, Y);

    if (gIsInSubMenu)
    {
        memcpy(gFrameBuffer[Y + 3] + 0, BITMAP_CurrentIndicator, sizeof(BITMAP_CurrentIndicator));
    }
}
...
void UI_DisplayMenu(void)
{
    ...
    case MENU_OFFSET:
        LayoutY = 0;
        UI_PrintString("MHz", 0, 127, 5, 8, true);
        break;
    ...
    case MENU_UPCODE:
        ...
        {
            LayoutY = 0;
            UI_PrintString(gEeprom.DTMF_UP_CODE + 8, 0, 127, 5, 8, true);
        }
        break;
    ...
    case MENU_DWCODE:
        ...
        {
            LayoutY = 0;
            UI_PrintString(gEeprom.DTMF_DOWN_CODE + 8, 0, 127, 5, 8, true);
        }
        break;
    ...
    case MENU_OFFSET:
        ...
        {
            sprintf(String, "%ld.%05ld", gSubMenuSelection / 100000, gSubMenuSelection % 100000);
            break;
        }
        for (i = 0; i < 3; i++)
        {
    ...
    case MENU_TOT:
        ...
        {
            sprintf(String, "%ldmin", gSubMenuSelection);
        }
        break;
    ...
    case MENU_RP_STE:
        ...
        {
            sprintf(String, "%ld*100ms", gSubMenuSelection);
        }
        break;

    case MENU_S_LIST:
        sprintf(String, "LIST%ld", gSubMenuSelection);
        break;
    ...
    case MENU_ABOUT:
        strncpy(String, Version, sizeof(String) - 1);
        break;
    ...
    UI_PrintString(String, 0, 127, LayoutY + 3, 8, true);
        ...
        gMenuCursor == MENU_R_DCS || gMenuCursor == MENU_T_DCS || gMenuCursor == MENU_D_LIST)
    {
        ...
        UI_DisplaySmallDigits(Offset, String + (8 - Offset), 105, LayoutY + 3);
    }

    ST7565_BlitFullScreen();
}
#else // ENABLE_HORIZONTAL_MENU_UI
void UI_DisplayMenu(void)
{
    char String[16];
    char Contact[16];
    ...
    case MENU_ABOUT:
    {
        ...
        strncpy(String, Version, Sep);
        String[Sep] = 0;
        UI_PrintString(String, 50, 127, 1, 8, true);
        strncpy(String, Version + Sep + 1, sizeof(String) - 1);
        String[sizeof(String) - 1] = 0;
...
#endif // ENABLE_HORIZONTAL_MENU_UI
