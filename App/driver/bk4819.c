...
#define _PORT_BK4819 GPIOB
#define _PIN_SCN LL_GPIO_PIN_3
#define _PIN_SCL LL_GPIO_PIN_4
#define _PIN_SDA LL_GPIO_PIN_5
...
{
    LL_GPIO_SetOutputPin(_PORT_BK4819, _PIN_SCN);
    LL_GPIO_SetOutputPin(_PORT_BK4819, _PIN_SCL);
    LL_GPIO_SetOutputPin(_PORT_BK4819, _PIN_SDA);
...
static uint16_t BK4819_ReadU16(void)
{
    ...
    LL_GPIO_SetPinMode(_PORT_BK4819, _PIN_SDA, LL_GPIO_MODE_INPUT);
    SYSTICK_DelayUs(1);
    ...
    {
        Value <<= 1;
        Value |= LL_GPIO_IsInputPinSet(_PORT_BK4819, _PIN_SDA);
        LL_GPIO_SetOutputPin(_PORT_BK4819, _PIN_SCL);
        SYSTICK_DelayUs(1);
        LL_GPIO_ResetOutputPin(_PORT_BK4819, _PIN_SCL);
        SYSTICK_DelayUs(1);
    }

    LL_GPIO_SetPinMode(_PORT_BK4819, _PIN_SDA, LL_GPIO_MODE_OUTPUT);
...
uint16_t BK4819_ReadRegister(BK4819_REGISTER_t Register)
{
    ...
    LL_GPIO_ResetOutputPin(_PORT_BK4819, _PIN_SCL);
    SYSTICK_DelayUs(1);
    LL_GPIO_ResetOutputPin(_PORT_BK4819, _PIN_SCN);
...
void BK4819_WriteU8(uint8_t Data)
{
    ...
    for (i = 0; i < 8; i++)
    {
        if ((Data & 0x80U) == 0)
        {
            LL_GPIO_ResetOutputPin(_PORT_BK4819, _PIN_SDA);
        }
        else
        {
            LL_GPIO_SetOutputPin(_PORT_BK4819, _PIN_SDA);
